...
pkgdatadir = $(datadir)/ntripcaster
pkgincludedir = $(includedir)/ntripcaster
pkglibdir = $(libdir)/ntripcaster
pkglibexecdir = $(libexecdir)/ntripcaster
...
NTRIPCASTER_BINDIR = /usr/local/ntripcaster/bin
NTRIPCASTER_ETCDIR = conf
NTRIPCASTER_ETCDIR_INST = /usr/local/ntripcaster/conf
NTRIPCASTER_LOGDIR = logs
NTRIPCASTER_LOGDIR_INST = /usr/local/ntripcaster/logs
OBJEXT = o
PACKAGE = ntripcaster
PACKAGE_BUGREPORT = 
PACKAGE_NAME = ntripcaster
PACKAGE_STRING = ntripcaster 0.1.16
PACKAGE_TARNAME = ntripcaster
PACKAGE_URL = 
