...
/* Define to 1 if you have the `zframe_new_empty' function. */
/* #undef HAVE_ZFRAME_NEW_EMPTY */

/* ZMQ base library */
#define HAVE_ZMQ /**/

/* Define to 1 if you have the `zmq_ctx_new' function. */
/* #undef HAVE_ZMQ_CTX_NEW */
...
/* Ntrip caster configuration directory */
#define NTRIPCASTER_ETCDIR "conf"

/* Ntrip caster logging directory */
...
#define PACKAGE_STRING "ntripcaster 0.1.16"
